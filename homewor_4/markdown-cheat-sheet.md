...
\[
H = -(0.8 \cdot \ln(0.8) + 0.2 \cdot \ln(0.2))
\]
\[
H = -(0.8 \cdot (-0.22314) + 0.2 \cdot (-1.60944))
\]
\[
H = -(-0.17851 - 0.32189)
\]
...
**Примечание:** В задании указан ответ 0.32, что предполагает другие исходные данные.
...
\[
\bar{y} = \frac{1 + 10 + 5 + 18 + 100 + 30 + 50 + 61 + 84 + 47}{10}
\]
\[
\bar{y} = \frac{406}{10} = 40.6
\]
...
**Вывод:** Уровень глюкозы в крови является наиболее важным предиктором диабета.
